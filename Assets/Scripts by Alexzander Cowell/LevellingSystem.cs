...
namespace AlexzanderCowell
{
    ...
    public class LevellingSystem : MonoBehaviour
    {
        ...
        private void OnTriggerEnter2D(Collider2D collision){
            if (collision.tag == ("PowerJump")){ // power box that gives you more jumping power.
        ...
        private void Update(){
            if (coins == 3){ // if the coins equal to 3 in total then it will activate the levelNext for the scene loader.
                levelNext = true;               
            }  
        }
